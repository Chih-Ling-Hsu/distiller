...
def cinic10_load_data(data_dir, batch_size, num_workers, valid_size=0.1, deterministic=False):
    """Load the CINIC10 dataset.    """
    ...
    train_dataset = datasets.ImageFolder(root='{}/train/'.format(data_dir), transform=transform)
    ...
    testset = datasets.ImageFolder(root='{}/test/'.format(data_dir), transform=transform_test)
